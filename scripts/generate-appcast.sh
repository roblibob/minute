...
Examples:
  ...
  scripts/generate-appcast.sh "$ROOT_DIR/updates" "https://github.com/roblibob/Minute/releases/download/v0.4a/"

Set SPARKLE_BIN to the Sparkle bin directory or generate_appcast path.
EOF
  exit 0
fi
